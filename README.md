...
Project Overview
The Student Management System is a Java-based console application developed to provide a simple and organized way of managing student records. The project allows users to maintain essential student information such as student ID, name, age, email address, and marks through a menu-driven interface.
